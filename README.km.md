...
- គណនីបុគ្គលិកថ្មីត្រូវបានបង្កើតតែដោយ Admin (តាមទំព័រ Users) ជាមួយ password
  ...
  (`auth/register.php`) ត្រូវបានបិទជាលំនាំដើម ហើយនឹងបញ្ជូនទៅទំព័រចូល
  ប្រើប្រាស់វិញជំនួសឱ្យការបង្កើតគណនី ដោយគ្រប់គ្រងតាមរយៈ env var
  `SELF_REGISTRATION_ENABLED` ដែលអាចបើកឡើងវិញបានដោយមិនចាំបាច់កែកូដ
  ប្រសិនបើត្រូវការនាពេលអនាគត។
