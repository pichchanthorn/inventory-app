-- ================================================
-- Migration 008: add updated_at/created_by/updated_by to products
--
-- Same pattern as migration 006 (categories/units/suppliers). products
-- already has created_at, so only these three columns are new here.
--
